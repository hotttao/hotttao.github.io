...
![基本配置下的预览](/images/hugo/basic-configuration-preview.zh-cn.png "基本配置下的预览")
...
![完整配置下的预览](/images/hugo/complete-configuration-preview.zh-cn.png "完整配置下的预览")
...
![语言切换](/images/hugo/language-switch.gif "语言切换")
