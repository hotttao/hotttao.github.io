...
```markdown
{{</* image src="/images/hugo/lighthouse.jpg" caption="Lighthouse (`image`)" src_s="/images/hugo/lighthouse-small.jpg" src_l="/images/hugo/lighthouse-large.jpg" */>}}
```
...
```markdown
{{</* music url="/music/Wavelength.mp3" name=Wavelength artist=oldmanyoung cover="/images/hugo/Wavelength.jpg" */>}}
```
